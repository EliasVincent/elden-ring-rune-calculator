    ...
    <div className="App">
      ...
      <div className="AllRuneContainers">
        <div className="RuneContainer">
          ...
          <img className="RuneImage" src={goldenRune1Img} alt="Golden Rune 1"></img>
          </div>
        ...
        <div className="RuneContainer">
          ...
          <div className="RuneImageContainer">
          <img className="RuneImage" src={goldenRune2Img} alt="Golden Rune 2"></img>
          </div>
          <div className="RuneButtonContainer">
            <button
              onClick={() => {
        ...
        <div className="RuneContainer">
          ...
          <div className="RuneImageContainer">
          <img className="RuneImage" src={goldenRune3Img} alt="Golden Rune 3"></img>
          </div>
          <div className="RuneButtonContainer">
            <button
              onClick={() => {
        ...
        <div className="RuneContainer">
          ...
          <div className="RuneImageContainer">
          <img className="RuneImage" src={goldenRune4Img} alt="Golden Rune 4"></img>
          </div>
          <div className="RuneButtonContainer">
            <button
              onClick={() => {
        ...
        <div className="RuneContainer">
          ...
          <div className="RuneImageContainer">
          <img className="RuneImage" src={goldenRune5Img} alt="Golden Rune 5"></img>
          </div>
          <div className="RuneButtonContainer">
            <button
              onClick={() => {
        ...
        <div className="RuneContainer">
          ...
          <div className="RuneImageContainer">
          <img className="RuneImage" src={goldenRune6Img} alt="Golden Rune 6"></img>
          </div>
          <div className="RuneButtonContainer">
            <button
              onClick={() => {
        ...
        <div className="RuneContainer">
          ...
          <div className="RuneImageContainer">
          <img className="RuneImage" src={goldenRune7Img} alt="Golden Rune 7"></img>
          </div>
          <div className="RuneButtonContainer">
            <button
              onClick={() => {
        ...
        <div className="RuneContainer">
          ...
          <div className="RuneImageContainer">
          <img className="RuneImage" src={goldenRune8Img} alt="Golden Rune 8"></img>
          </div>
          <div className="RuneButtonContainer">
            <button
              onClick={() => {
        ...
        <div className="RuneContainer">
          ...
          <div className="RuneImageContainer">
          <img className="RuneImage" src={goldenRune9Img} alt="Golden Rune 9"></img>
          </div>
          <div className="RuneButtonContainer">
            <button
              onClick={() => {
        ...
        <div className="RuneContainer">
          ...
          <div className="RuneImageContainer">
          <img className="RuneImage" src={goldenRune10Img} alt="Golden Rune 10"></img>
          </div>
          <div className="RuneButtonContainer">
            <button
              onClick={() => {
        ...
        <div className="RuneContainer">
          ...
          <div className="RuneImageContainer">
          <img className="RuneImage" src={goldenRune10Img} alt="Golden Rune 11"></img>
          </div>
          <div className="RuneButtonContainer">
            <button
              onClick={() => {
        ...
        <div className="RuneContainer">
          ...
          <div className="RuneImageContainer">
          <img className="RuneImage" src={goldenRune12Img} alt="Golden Rune 12"></img>
          </div>
          <div className="RuneButtonContainer">
            <button
              onClick={() => {
        ...
        <div className="RuneContainer">
          ...
          <div className="RuneImageContainer">
          <img className="RuneImage" src={goldenRune12Img} alt="Golden Rune 13"></img>
          </div>
          <div className="RuneButtonContainer">
            <button
              onClick={() => {
        ...
        <div className="RuneContainer">
          ...
          <div className="RuneImageContainer">
          <img className="RuneImage" src={goldenRune12Img} alt="Numen's Rune"></img>
          </div>
          <div className="RuneButtonContainer">
            <button
              onClick={() => {
      ...
      <div className="RuneContainer">
        ...
        <div className="RuneImageContainer">
        <img className="RuneImage" src={herosRune1Img} alt="Hero's Rune 1"></img>
        </div>
        <div className="RuneButtonContainer">
          <button
            onClick={() => {
      ...
      <div className="RuneContainer">
        ...
        <div className="RuneImageContainer">
        <img className="RuneImage" src={herosRune1Img} alt="Hero's Rune 2"></img>
        </div>
        <div className="RuneButtonContainer">
          <button
            onClick={() => {
      ...
      <div className="RuneContainer">
        ...
        <div className="RuneImageContainer">
        <img className="RuneImage" src={herosRune1Img} alt="Hero's Rune 3"></img>
        </div>
        <div className="RuneButtonContainer">
          <button
            onClick={() => {
      ...
      <div className="RuneContainer">
        ...
        <div className="RuneImageContainer">
        <img className="RuneImage" src={herosRune4Img} alt="Hero's Rune 4"></img>
        </div>
        <div className="RuneButtonContainer">
          <button
            onClick={() => {
      ...
      <div className="RuneContainer">
        ...
        <div className="RuneImageContainer">
        <img className="RuneImage" src={herosRune5Img} alt="Hero's Rune 5"></img>
        </div>
        <div className="RuneButtonContainer">
          <button
            onClick={() => {
      ...
      <div className="RuneContainer">
        <div>Lord's Rune</div>
        <div className="RuneImageContainer">
        <img className="RuneImage" src={lordsRuneImg} alt="Lord's Rune"></img>
        </div>
        <div className="RuneButtonContainer">
          <button
            onClick={() => {
